...
describe.each([
  [
    ...
    ['app-chart-colour--light-blue', 'app-chart-colour--dark-blue', 'app-chart-colour--turquoise'],
  ],
  [
  ...
  [
    ...
    ['app-chart-colour--dark-blue', 'app-chart-colour--turquoise', 'app-chart-colour--yellow'],
  ],
  [
    'with a different incentive level missing',
    ['Basic', 'Standard', 'Enhanced 2'],
    ['app-chart-colour--light-blue', 'app-chart-colour--dark-blue', 'app-chart-colour--yellow'],
  ],
  [
  ...
  [
    ...
    ['Positive', 'Negative'],
    ['app-chart-colour--light-blue', 'app-chart-colour--dark-blue'],
  ],
  [
